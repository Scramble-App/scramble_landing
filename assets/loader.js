...
(function (factory) {
  ...
  pageLoader.collection = document.body; //querySelectorAll('.playground');
  window.addEventListener('load', function () {
    ...
    pageLoad.progress(function (e) {
      ...
      // console.log(e);
      progressBar.style.maxWidth = pageLoader.percentage + '%';
      // loader.innerHTML = pageLoader.percentage + '%';
      // console.log('Total page load: ' + pageLoader.percentage + '% ' + e.resource.url);
